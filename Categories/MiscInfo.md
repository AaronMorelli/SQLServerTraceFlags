...
| 2505 | [Randal-SQL-SDB407](https://www.scribd.com/document/109431789/Randal-SQL-SDB407-Undocumented): “Turns off tracing calls to DBCC TRACEON/TRACEOFF”. *According to the (very old) KB article, prevents messages of the form “99/03/04 12:42:07.28 spid10 DBCC TRACEON 208, SPID 10” from being written to the SQL error log. (Note: DBCC TRACEON(208) just means “SET QUOTED IDENTIFIER ON”)* | [243352](http://support.microsoft.com/kb/243352/en-us) | 
...
| 3688 | Suppresses messages 19030 (SQL Trace ID %d was started by login "%s") and 19031 (SQL Trace stopped. Trace ID = '%d'. Login Name = '%s') from going to the SQL error log. The KB article on the right notes that pre-2005 versions of SQL Server could accomplish similar behavior with the sp_altermessage procedure. | [922578](http://support.microsoft.com/kb/922578) | 
| | | | 
